...
object StringOps {
  ...
  val aString: String = "Yooooo Scala learning yeyeyeye"

  //string functions:
  val secondChar = aString.charAt(1) // getting a char from the val
  val firstWord = aString.substring(0,5) // gives you range of char eg: give Yooooo
